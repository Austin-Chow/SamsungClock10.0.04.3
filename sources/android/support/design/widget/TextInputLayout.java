...
public class TextInputLayout extends LinearLayout implements WithHint {
    ...
    class C00511 implements TextWatcher {
        C00511() {
        }
    ...
    class C00555 implements AnimatorUpdateListener {
        C00555() {
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C00561 implements ClassLoaderCreator<SavedState> {
            C00561() {
            }
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0011R.styleable.TextInputLayout, defStyleAttr, C0011R.style.Widget_Design_TextInputLayout);
        this.mHintEnabled = a.getBoolean(C0011R.styleable.TextInputLayout_hintEnabled, true);
        setHint(a.getText(C0011R.styleable.TextInputLayout_android_hint));
        this.mHintAnimationEnabled = a.getBoolean(C0011R.styleable.TextInputLayout_hintAnimationEnabled, true);
        if (a.hasValue(C0011R.styleable.TextInputLayout_android_textColorHint)) {
            ColorStateList colorStateList = a.getColorStateList(C0011R.styleable.TextInputLayout_android_textColorHint);
            this.mFocusedTextColor = colorStateList;
            this.mDefaultTextColor = colorStateList;
        }
        if (a.getResourceId(C0011R.styleable.TextInputLayout_hintTextAppearance, -1) != -1) {
            setHintTextAppearance(a.getResourceId(C0011R.styleable.TextInputLayout_hintTextAppearance, 0));
        }
        this.mErrorTextAppearance = a.getResourceId(C0011R.styleable.TextInputLayout_errorTextAppearance, 0);
        boolean errorEnabled = a.getBoolean(C0011R.styleable.TextInputLayout_errorEnabled, false);
        boolean counterEnabled = a.getBoolean(C0011R.styleable.TextInputLayout_counterEnabled, false);
        setCounterMaxLength(a.getInt(C0011R.styleable.TextInputLayout_counterMaxLength, -1));
        this.mCounterTextAppearance = a.getResourceId(C0011R.styleable.TextInputLayout_counterTextAppearance, 0);
        this.mCounterOverflowTextAppearance = a.getResourceId(C0011R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);
        this.mPasswordToggleEnabled = a.getBoolean(C0011R.styleable.TextInputLayout_passwordToggleEnabled, false);
        this.mPasswordToggleDrawable = a.getDrawable(C0011R.styleable.TextInputLayout_passwordToggleDrawable);
        this.mPasswordToggleContentDesc = a.getText(C0011R.styleable.TextInputLayout_passwordToggleContentDescription);
        if (a.hasValue(C0011R.styleable.TextInputLayout_passwordToggleTint)) {
            this.mHasPasswordToggleTintList = true;
            this.mPasswordToggleTintList = a.getColorStateList(C0011R.styleable.TextInputLayout_passwordToggleTint);
        }
        if (a.hasValue(C0011R.styleable.TextInputLayout_passwordToggleTintMode)) {
            this.mHasPasswordToggleTintMode = true;
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(a.getInt(C0011R.styleable.TextInputLayout_passwordToggleTintMode, -1), null);
        }
        a.recycle();
    ...
    private void setEditText(EditText editText) {
        ...
        this.mEditText.addTextChangedListener(new C00511());
    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.mErrorView.setId(C0011R.id.textinput_error);
                ...
                if (useDefaultColor) {
                    TextViewCompat.setTextAppearance(this.mErrorView, C0247R.style.TextAppearance_AppCompat_Caption);
                    this.mErrorView.setTextColor(ContextCompat.getColor(getContext(), C0247R.color.sesl_error_color));
                }
    ...
    private void setError(final CharSequence error, boolean animate) {
        ...
        if (this.mErrorShown) {
            ...
            if (animate) {
                ...
                this.mErrorView.animate().alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C00522()).start();
            } else {
    ...
    public void setCounterEnabled(boolean enabled) {
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                this.mCounterView.setId(C0011R.id.textinput_counter);
                if (this.mTypeface != null) {
                ...
                try {
                    ...
                    TextViewCompat.setTextAppearance(this.mCounterView, C0247R.style.TextAppearance_AppCompat_Caption);
                    this.mCounterView.setTextColor(ContextCompat.getColor(getContext(), C0247R.color.sesl_error_color));
                }
    ...
    void updateCounter(int length) {
        ...
        if (this.mCounterMaxLength == -1) {
            ...
            this.mCounterView.setText(getContext().getString(C0011R.string.sesl_character_counter_pattern, new Object[]{Integer.valueOf(length), Integer.valueOf(this.mCounterMaxLength)}));
        }
        ...
        if (this.mEditText != null) {
            ...
            if (shouldShowPasswordIcon()) {
                if (this.mPasswordToggleView == null) {
                    this.mPasswordToggleView = (CheckableImageButton) LayoutInflater.from(getContext()).inflate(C0011R.layout.sesl_text_input_password_icon, this.mInputFrame, false);
                    ...
                    this.mPasswordToggleView.setOnClickListener(new C00544());
                }
                ...
                int measuredWidth = this.mPasswordToggleView.getMeasuredWidth();
                if (measuredWidth <= 0) {
                    this.mPasswordToggleView.measure(0, 0);
                    measuredWidth = this.mPasswordToggleView.getMeasuredWidth();
                }
                this.mPasswordToggleDummyDrawable.setBounds(0, 0, measuredWidth, 1);
    ...
    void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.addUpdateListener(new C00555());
            }

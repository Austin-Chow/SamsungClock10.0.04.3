...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attrs) {
        ...
        this.mMaxWidth = a.getDimensionPixelSize(C0011R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.mMaxInlineActionWidth = a.getDimensionPixelSize(C0011R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
        a.recycle();
    }

    protected void onFinishInflate() {
        super.onFinishInflate();
        this.mMessageView = (TextView) findViewById(C0011R.id.snackbar_text);
        this.mActionView = (Button) findViewById(C0011R.id.snackbar_action);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int multiLineVPadding = getResources().getDimensionPixelSize(C0011R.dimen.sesl_snackbar_padding_vertical_2lines);
        int singleLineVPadding = getResources().getDimensionPixelSize(C0011R.dimen.sesl_snackbar_padding_vertical);

...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild2, NestedScrollingParent, ScrollingView {
    ...
    private boolean mForcedNestedScrollEnabled;
    ...
    public NestedScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mForcedNestedScrollEnabled = false;
    ...
    public void seslForcedNestedScrollEnabled(boolean enabled) {
        this.mForcedNestedScrollEnabled = enabled;
    }
                    ...
                    if (!this.mIsBeingDragged) {
                        ...
                        if (vscroll != 0.0f) {
                            ...
                            if (newScrollY != oldScrollY) {
                                startNestedScroll(newScrollY, 1);
                                if (dispatchNestedPreScroll(0, newScrollY, null, null, 1)) {
                                    return true;
                                }
    ...
    public void computeScroll() {
        if (this.mScroller.computeScrollOffset()) {
            ...
            if (dy != 0) {
                ...
                if ((this.mForcedNestedScrollEnabled || scrolledDeltaY != 0) && !dispatchNestedScroll(0, scrolledDeltaY, 0, unconsumedY, null, 1)) {

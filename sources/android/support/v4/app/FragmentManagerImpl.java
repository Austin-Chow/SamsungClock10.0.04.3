...
final class FragmentManagerImpl extends FragmentManager implements Factory2 {
    ...
    int mCurState = 0;
    boolean mDestroyed;
    Runnable mExecCommit = new C00881();
    ...
    L_0x0240:
        ...
        if (r2 != 0) goto L_0x0283;
    L_0x0244:
        r2 = r15.getResources();	 Catch:{ NotFoundException -> 0x0359 }
        r3 = r15.mContainerId;	 Catch:{ NotFoundException -> 0x0359 }
        r12 = r2.getResourceName(r3);	 Catch:{ NotFoundException -> 0x0359 }
    L_0x024e:
        r2 = new java.lang.IllegalArgumentException;
        r3 = new java.lang.StringBuilder;
        r3.<init>();
    ...
    public boolean dispatchCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        if (this.mCurState < 1 || this.mAdded == null) {
            return false;
        }
        int i;
        boolean show = false;

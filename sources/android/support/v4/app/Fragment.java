...
public class Fragment implements LifecycleOwner, ComponentCallbacks, OnCreateContextMenuListener {
    ...
    class C00852 extends FragmentContainer {
        C00852() {
        }
    ...
    public void startPostponedEnterTransition() {
        if (this.mFragmentManager == null || this.mFragmentManager.mHost == null) {
            ...
            this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new C00841());
        } else {
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new C00852(), this);
    }

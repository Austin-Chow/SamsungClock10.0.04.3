...
public abstract class PreferenceGroup extends Preference {
    ...
    public PreferenceGroup(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mClearRecycleCacheRunnable = new C02591();
        this.mPreferenceList = new ArrayList();
        TypedArray a = context.obtainStyledAttributes(attrs, C0263R.styleable.PreferenceGroup, defStyleAttr, defStyleRes);
        this.mOrderingAsAdded = TypedArrayUtils.getBoolean(a, C0263R.styleable.PreferenceGroup_orderingFromXml, C0263R.styleable.PreferenceGroup_orderingFromXml, true);
        a.recycle();
    }

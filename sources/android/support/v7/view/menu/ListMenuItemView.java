...
public class ListMenuItemView extends LinearLayout implements ItemView {
    ...
    private NumberFormat mNumberFotmat;
    ...
    public ListMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        this.mNumberFotmat = NumberFormat.getInstance(Locale.getDefault());
    }

    protected void onFinishInflate() {
        super.onFinishInflate();
        ViewCompat.setBackground(this, this.mBackground);
        this.mTitleView = (TextView) findViewById(C0247R.id.title);
        if (this.mTextAppearance != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, this.mTextAppearance);
        }
        this.mShortcutView = (TextView) findViewById(C0247R.id.shortcut);
        this.mSubMenuArrowView = (ImageView) findViewById(C0247R.id.submenuarrow);
    ...
    private void insertIconView() {
        this.mIconView = (ImageView) getInflater().inflate(C0247R.layout.sesl_list_menu_item_icon, this, false);
        addView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        this.mRadioButton = (RadioButton) getInflater().inflate(C0247R.layout.sesl_list_menu_item_radio, this, false);
        this.mRadioButton.setBackground(null);
        addView(this.mRadioButton);
    }

    private void insertCheckBox() {
        this.mCheckBox = (CheckBox) getInflater().inflate(C0247R.layout.sesl_list_menu_item_checkbox, this, false);
    ...
    private void setBadgeText(String text) {
        ...
        if (isNumericValue(text)) {
            ...
            String localeFormattedNumber = this.mNumberFotmat.format((long) num);
            ...
            lp.width = (int) (getResources().getDimension(C0247R.dimen.sesl_badge_default_width) + (((float) localeFormattedNumber.length()) * getResources().getDimension(C0247R.dimen.sesl_badge_additional_width)));
            this.mBadgeView.setLayoutParams(lp);
        } else {
            this.mBadgeView.setText(text);
        }
    ...
    private void insertBadge() {
        this.mBadgeView = (TextView) getInflater().inflate(C0247R.layout.sesl_list_menu_item_badge, this, false);

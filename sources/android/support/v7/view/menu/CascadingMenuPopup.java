...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C02742();
    private final Context mContext;
    private int mDropDownGravity = 0;
    private boolean mForceShowIcon;
    private final OnGlobalLayoutListener mGlobalLayoutListener = new C02731();
    ...
    class C02731 implements OnGlobalLayoutListener {
        C02731() {
        }
    ...
    class C02742 implements OnAttachStateChangeListener {
        C02742() {
        }
    ...
    private void showMenu(MenuBuilder menu) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            View titleItemView = (FrameLayout) inflater.inflate(C0247R.layout.sesl_popup_menu_header_item_layout, listView, false);

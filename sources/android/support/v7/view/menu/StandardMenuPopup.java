...
final class StandardMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnItemClickListener, OnDismissListener {
    ...
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C02802();
    private int mContentWidth;
    private final Context mContext;
    private int mDropDownGravity = 0;
    private final OnGlobalLayoutListener mGlobalLayoutListener = new C02791();
    ...
    class C02791 implements OnGlobalLayoutListener {
        C02791() {
        }
    ...
    class C02802 implements OnAttachStateChangeListener {
        C02802() {
        }
    ...
    public StandardMenuPopup(Context context, MenuBuilder menu, View anchorView, int popupStyleAttr, int popupStyleRes, boolean overflowOnly) {
        ...
        this.mAdapter = new MenuAdapter(menu, LayoutInflater.from(this.mContext), this.mOverflowOnly);
    ...
    private boolean tryShow() {
        ...
        if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
            FrameLayout titleItemView = (FrameLayout) LayoutInflater.from(this.mContext).inflate(C0247R.layout.sesl_popup_menu_header_item_layout, listView, false);

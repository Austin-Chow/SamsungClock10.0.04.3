...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, Factory2 {
    ...
    class C02335 implements Runnable {
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C02321());
                return;
            }
            AppCompatDelegateImplV9.this.mActionModeView.setAlpha(1.0f);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    protected static final class PanelFeatureState {
        ...
        MenuView getListMenuView(MenuPresenter.Callback cb) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0247R.layout.sesl_list_menu_item_layout);
    ...
    private ViewGroup createSubDecor() {
        ...
        if (a.hasValue(C0247R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (a.hasValue(C0247R.styleable.AppCompatTheme_ignoreRemoveSystemTopInset)) {
                this.mIsIgnoreRemoveSystemTopInset = a.getBoolean(C0247R.styleable.AppCompatTheme_ignoreRemoveSystemTopInset, false);
            }
            a.recycle();
            ...
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    subDecor = (ViewGroup) inflater.inflate(C0247R.layout.sesl_screen_simple_overlay_action_mode, null);
                } else {
                    subDecor = (ViewGroup) inflater.inflate(C0247R.layout.sesl_screen_simple, null);
                }
                ...
                subDecor = (ViewGroup) inflater.inflate(C0247R.layout.sesl_dialog_title, null);
                ...
                subDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(C0247R.layout.sesl_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) subDecor.findViewById(C0247R.id.decor_content_parent);
            ...
            if (this.mDecorContentParent == null) {
                this.mTitleView = (TextView) subDecor.findViewById(C0247R.id.title);
            }
            ViewUtils.makeOptionalFitsSystemWindows(subDecor);
            ContentFrameLayout contentView = (ContentFrameLayout) subDecor.findViewById(C0247R.id.action_bar_activity_content);
            ...
            contentView.setAttachListener(new C02314());
            return subDecor;
        }
        a.recycle();
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    ViewStubCompat stub;
                    View subDecorCollapsingLayout = this.mSubDecor.findViewById(this.mSubDecor.getContext().getResources().getIdentifier("collapsing_toolbar", "id", this.mSubDecor.getContext().getPackageName()));
                    if (subDecorCollapsingLayout == null) {
                        stub = (ViewStubCompat) this.mSubDecor.findViewById(C0247R.id.action_mode_bar_stub);
                    } else if (this.mOverlayActionMode) {
                        stub = (ViewStubCompat) this.mSubDecor.findViewById(C0247R.id.action_mode_bar_stub);
                    } else {
                        stub = (ViewStubCompat) subDecorCollapsingLayout.findViewById(C0247R.id.action_mode_bar_stub);
                    }
                    if (stub != null) {
        ...
        if (!st.isOpen && !isDestroyed()) {
            ...
            if (cb == null || cb.onMenuOpened(st.featureId, st.menu)) {
                ...
                if (wm != null && preparePanel(st, event)) {
                    ...
                    st.isHandled = false;
                    WindowManager.LayoutParams lp2 = new WindowManager.LayoutParams(width, -2, st.f6x, st.f7y, PointerIconCompat.TYPE_HAND, 8519680, -3);
    ...
    void closePanel(PanelFeatureState st, boolean doCallback) {
        ...
        if (!(wm == null || !st.isOpen || st.decorView == null)) {
            ...
            } else if (st.decorView.isAttachedToWindow()) {
                wm.removeView(st.decorView);
            }
            if (doCallback) {
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (mlp.topMargin != newMargin) {
                    ...
                    if (this.mStatusGuard == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0247R.color.sesl_input_method_navigation_guard));
                        this.mSubDecor.addView(this.mStatusGuard, -1, new LayoutParams(-1, insetTop));
                    } else {
                        lp = this.mStatusGuard.getLayoutParams();
                ...
                if (!(this.mOverlayActionMode || !showStatusGuard || this.mIsIgnoreRemoveSystemTopInset)) {
                    insetTop = 0;
                }

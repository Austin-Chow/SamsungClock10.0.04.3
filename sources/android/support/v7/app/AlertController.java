...
import android.support.v4.widget.SeslAbsListViewReflector;
...
class AlertController {
    ...
    AppCompatButton mButtonNeutral;
    ...
    public static class ButtonBarLayout extends LinearLayout {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            for (i = 0; i < count; i++) {
                ...
                if (child.getVisibility() != 8 && (child instanceof AppCompatButton)) {
            ...
            if (beforeChildrenWidth < afterChildrenWidth || width < afterChildrenWidth) {
                ...
                setOrientation(0);
                boolean buttonPositiveVisible = findViewById(C0247R.id.button1).getVisibility() == 0;
                boolean buttonNegativeVisible = findViewById(C0247R.id.button2).getVisibility() == 0;
                boolean buttonNeutralVisible = findViewById(C0247R.id.button3).getVisibility() == 0;
                View divider1 = findViewById(C0247R.id.sem_divider1);
                View divider2 = findViewById(C0247R.id.sem_divider2);
    ...
    public static class RecycleListView extends ListView {
        ...
        public void setOverScrollMode(int mode) {
            if (mode == 2) {
                ...
                SeslEdgeEffect topEdgeEffect = new SeslEdgeEffect(context);
                SeslEdgeEffect bottomEdgeEffect = new SeslEdgeEffect(context);
                topEdgeEffect.setSeslHostView(this);
                bottomEdgeEffect.setSeslHostView(this);
                SeslAbsListViewReflector.setField_mEdgeGlowTop(this, topEdgeEffect);
                SeslAbsListViewReflector.setField_mEdgeGlowBottom(this, bottomEdgeEffect);
            }
    ...
    private void setupView() {
        ...
        View parentPanel = this.mWindow.findViewById(C0247R.id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0247R.id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0247R.id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0247R.id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0247R.id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0247R.id.topPanel);
        View customContentPanel = customPanel.findViewById(C0247R.id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0247R.id.buttonPanel);
        ...
        if (buttonPanel == null || buttonPanel.getVisibility() == 8) {
        ...
        AdapterView listView = this.mListView;
        if (listView != null && this.mAdapter != null) {
            listView.setAdapter(this.mAdapter);
            SeslAdapterViewReflector.setBottomColor(listView, 0);
            int checkedItem = this.mCheckedItem;
            if (checkedItem > -1) {
                listView.setItemChecked(checkedItem, true);
                listView.setSelectionFromTop(checkedItem, this.mContext.getResources().getDimensionPixelSize(C0247R.dimen.sesl_select_dialog_padding_top));
            }
        }
    }

    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0247R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0247R.id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0247R.id.custom);
    ...
    private void adjustButtonsPadding() {
        int textSize = this.mContext.getResources().getDimensionPixelSize(C0247R.dimen.sesl_dialog_button_text_size);
        if (this.mButtonPositive.getVisibility() != 8) {
            this.mButtonPositive.setTextSize(0, (float) textSize);
            checkMaxFontScale(this.mButtonPositive, textSize);
        }
        if (this.mButtonNegative.getVisibility() != 8) {
            this.mButtonNegative.setTextSize(0, (float) textSize);
            checkMaxFontScale(this.mButtonNegative, textSize);
        }
        if (this.mButtonNeutral.getVisibility() != 8) {
            this.mButtonNeutral.setTextSize(0, (float) textSize);
            checkMaxFontScale(this.mButtonNeutral, textSize);
        }
    }
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0247R.id.title_template).setVisibility(8);
            return;
        }
        ...
        if (hasTextTitle && this.mShowTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0247R.id.alertTitle);
            this.mTitleView.setText(this.mTitle);
            checkMaxFontScale(this.mTitleView, this.mContext.getResources().getDimensionPixelSize(C0247R.dimen.sesl_dialog_title_text_size));
            if (this.mIconId != 0) {
                this.mIconView.setImageResource(this.mIconId);
                return;
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0247R.id.scrollView);
    ...
    private void setupButtons(ViewGroup buttonPanel) {
        ...
        boolean isShowButtonBackgroundEnabled = contentResolver != null && System.getInt(contentResolver, "show_button_background", 0) == 1;
        TypedValue outValue = new TypedValue();
        this.mContext.getTheme().resolveAttribute(16842801, outValue, true);
        int backgroundColor = -1;
        if (outValue.resourceId > 0) {
            backgroundColor = this.mContext.getResources().getColor(outValue.resourceId);
        }
        int whichButtons = 0;
        this.mButtonPositive = (AppCompatButton) buttonPanel.findViewById(C0247R.id.button1);
        this.mButtonPositive.setOnClickListener(this.mButtonHandler);
        if (VERSION.SDK_INT > 26) {
            if (outValue.resourceId > 0) {
                this.mButtonPositive.seslSetButtonShapeEnabled(isShowButtonBackgroundEnabled, backgroundColor);
            } else {
                this.mButtonPositive.seslSetButtonShapeEnabled(isShowButtonBackgroundEnabled);
            }
        } else if (isShowButtonBackgroundEnabled) {
            this.mButtonPositive.setBackgroundResource(C0247R.drawable.sesl_dialog_show_button_background);
        }
        ...
        this.mButtonNegative = (AppCompatButton) buttonPanel.findViewById(C0247R.id.button2);
        this.mButtonNegative.setOnClickListener(this.mButtonHandler);
        if (VERSION.SDK_INT > 26) {
            if (outValue.resourceId > 0) {
                this.mButtonNegative.seslSetButtonShapeEnabled(isShowButtonBackgroundEnabled, backgroundColor);
            } else {
                this.mButtonNegative.seslSetButtonShapeEnabled(isShowButtonBackgroundEnabled);
            }
        } else if (isShowButtonBackgroundEnabled) {
            this.mButtonNegative.setBackgroundResource(C0247R.drawable.sesl_dialog_show_button_background);
        }
        ...
        this.mButtonNeutral = (AppCompatButton) buttonPanel.findViewById(C0247R.id.button3);
        this.mButtonNeutral.setOnClickListener(this.mButtonHandler);
        if (VERSION.SDK_INT > 26) {
            if (outValue.resourceId > 0) {
                this.mButtonNeutral.seslSetButtonShapeEnabled(isShowButtonBackgroundEnabled, backgroundColor);
            } else {
                this.mButtonNeutral.seslSetButtonShapeEnabled(isShowButtonBackgroundEnabled);
            }
        } else if (isShowButtonBackgroundEnabled) {
            this.mButtonNeutral.setBackgroundResource(C0247R.drawable.sesl_dialog_show_button_background);
        }
        ...
        View divider1 = this.mWindow.findViewById(C0247R.id.sem_divider1);
        View divider2 = this.mWindow.findViewById(C0247R.id.sem_divider2);
    ...
    private void centerButton(AppCompatButton button) {

...
import android.support.v4.os.SeslPerfManagerReflector;
...
class SeslOverScroller {
    ...
    static class SplineOverScroller {
        ...
        public void setRegulationEnabled(boolean enabled) {
            boolean z = sEnableSmoothFling && enabled;
            sRegulateCurrentTimeInterval = z;
        }
        ...
        void fling(int start, int velocity, int min, int max, int over) {
            ...
            if (velocity != 0) {
                ...
                if (sEnableSmoothFling && !this.mIsDVFSBoosting && (velocity >= 800 || velocity <= -800)) {
        ...
        private double getSplineFlingDistance(int velocity) {
            ...
            return ((((double) this.mFlingFriction) * ((double) ((3.0f * (END_TENSION - SPLINE_POSITION[index])) + DISTANCE_M2))) * ((double) this.mPhysicalCoeff)) * Math.exp((((double) DECELERATION_RATE) / decelMinusOne) * l);
        }
    ...
    public void setRegulationEnabled(boolean enabled) {
        this.mScrollerX.setRegulationEnabled(enabled);
        this.mScrollerY.setRegulationEnabled(enabled);
    }
}

...
public class Toolbar extends ViewGroup {
    ...
    class C04041 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C04041() {
        }
    ...
    class C04063 implements OnClickListener {
        C04063() {
        }
    ...
    public Toolbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C04041();
        this.mShowOverflowMenuRunnable = new C04052();
        ...
        this.mBackground = a.getDrawable(C0247R.styleable.Toolbar_background);
        this.mNavTooltipText = a.getText(C0247R.styleable.Toolbar_tooltipText);
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(C0247R.styleable.AppCompatTheme);
        int actionBarHeight = a.getDimensionPixelSize(C0247R.styleable.AppCompatTheme_actionBarSize, 0);
        a.recycle();
        android.view.ViewGroup.LayoutParams lp = getLayoutParams();
        lp.height = actionBarHeight;
        setLayoutParams(lp);
        a = getContext().obtainStyledAttributes(null, C0247R.styleable.Toolbar, 16843946, 0);
        int maxButtonHeight = a.getDimensionPixelSize(C0247R.styleable.Toolbar_maxButtonHeight, -1);
        if (maxButtonHeight >= -1) {
            this.mMaxButtonHeight = maxButtonHeight;
        }
        int minHeight = a.getDimensionPixelSize(C0247R.styleable.Toolbar_android_minHeight, -1);
        if (minHeight >= -1) {
    ...
    public void setTitleAccessibilityEnabled(boolean enabled) {
        if (enabled) {
            if (this.mTitleTextView != null) {
                this.mTitleTextView.setImportantForAccessibility(1);
            }
            if (this.mSubtitleTextView != null) {
                this.mSubtitleTextView.setImportantForAccessibility(1);
                return;
            }
            return;
        }
        ...
        if (this.mSubtitleTextView != null) {
            this.mSubtitleTextView.setImportantForAccessibility(2);
        }
    }
    ...
    public void setNavigationContentDescription(CharSequence description) {
        ...
        if (this.mNavButtonView != null) {
            ...
            if (TYPE_NONE != -1) {
                SeslViewReflector.semSetHoverPopupType(this.mNavButtonView, TYPE_NONE);
            }
            this.mNavButtonView.setContentDescription(description);
            CharSequence tooltip = TextUtils.isEmpty(this.mNavTooltipText) ? description : this.mNavTooltipText;
            this.mNavTooltipText = tooltip;
            TooltipCompat.setTooltipText(this.mNavButtonView, tooltip);
        }
    }
    ...
    public boolean performLongClick() {
        ...
        TooltipCompat.setTooltipText(this, this.mNavTooltipText);
    ...
    protected void setTooltipOffset(View view) {
        if (view != null) {
            int xOffset;
            Context context = getContext();
            ...
            if ((toolBar instanceof Toolbar) && toolBar.getWidth() < displayFrame.right - displayFrame.left) {
                diff = (screenPos[0] - windowPos[0]) - displayFrame.right;
            }
            ...
            if (layoutDirection == 0) {
                ...
                if (rotate == 3 && checkNaviBarForLandscape()) {
                    ...
                    xOffset = getNavigationBarHeight() < navigationBarHeight ? (xOffset - ((int) ((((float) navigationBarHeight) / density) * realDensity))) - (width / 2) : xOffset - ((int) ((((float) navigationBarHeight) / density) * realDensity));
                }
            } else {
                xOffset = windowViewPos[0] - width;
                if (rotate == 1 && checkNaviBarForLandscape()) {
                    xOffset -= (int) ((((float) navigationBarHeight) / res.getDisplayMetrics().density) * realDisplayMetrics.density);
                }
            }
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            ...
            this.mCollapseButtonView.setOnClickListener(new C04063());
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            ...
            Drawable d = this.mNavButtonView.getDrawable();
            Drawable bg = this.mNavButtonView.getBackground();
            if (!(d == null || bg == null)) {
                int halfOffsetX = (this.mNavButtonView.getPaddingLeft() - this.mNavButtonView.getPaddingRight()) / 2;
                bg.setHotspotBounds(halfOffsetX, 0, halfOffsetX + navWidth, height);
            }
        }
        ...
        if (shouldLayout(this.mTitleTextView)) {
            TypedArray a = getContext().obtainStyledAttributes(this.mTitleTextAppearance, C0247R.styleable.TextAppearance);
            TypedValue value = a.peekValue(C0247R.styleable.TextAppearance_android_textSize);
            float textSize = (float) getResources().getDimensionPixelSize(C0247R.dimen.sesl_action_bar_text_size_title);
            if (value != null) {
                textSize = TypedValue.complexToFloat(value.data);
            }
            a.recycle();
            a = getContext().obtainStyledAttributes(this.mSubtitleTextAppearance, C0247R.styleable.TextAppearance);
            value = a.peekValue(C0247R.styleable.TextAppearance_android_textSize);
            float subtextSize = (float) getResources().getDimensionPixelSize(C0247R.dimen.sesl_action_bar_text_size_subtitle);
            if (value != null) {
                subtextSize = TypedValue.complexToFloat(value.data);
            }
            a.recycle();
            if (textSize == -1.0f || !TextUtils.isEmpty(this.mSubtitleText)) {
                this.mTitleTextView.setTextSize(1, textSize);
                this.mSubtitleTextView.setTextSize(1, subtextSize);
            } else {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int alignmentHeight = minHeight >= 0 ? Math.max(minHeight, b - t) : 0;
        if (shouldLayout(this.mNavButtonView)) {
            if (isRtl) {

...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            ...
            int getGapForSpan(int spanIndex) {
                return (this.mGapPerSpan == null || this.mGapPerSpan.length <= spanIndex) ? 0 : this.mGapPerSpan[spanIndex];
            }
    ...
    boolean checkForGaps() {
        ...
        if (minPos == 0 && hasGapsToFix() != null) {
            ...
            FullSpanItem invalidFsi = this.mLazySpanLookup.getFirstFullSpanItemInRange(minPos - 1, maxPos + 1, invalidGapDir, true);
            if (invalidFsi == null) {

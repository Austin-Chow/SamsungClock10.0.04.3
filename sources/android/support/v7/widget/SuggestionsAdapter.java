...
import android.support.v4.text.SeslTextUtilsReflector;
...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            this.mIconRefine = (ImageView) v.findViewById(C0247R.id.edit_query);
        }
    }
    ...
    public SuggestionsAdapter(Context context, SearchView searchView, SearchableInfo searchable, WeakHashMap<String, ConstantState> outsideDrawablesCache) {
        ...
        int[] attr = new int[]{16843828};
        TypedArray a = context.obtainStyledAttributes(new TypedValue().data, attr);
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        ((ImageView) v.findViewById(C0247R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return v;
    }

    private static char[] getPrefixCharForIndian(TextPaint textPaint, String string, char[] chars) {
        return SeslTextUtilsReflector.semGetPrefixCharForSpan(textPaint, string, chars);
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (views.mText1 != null) {
            ...
            if (text1 != null) {
                CharSequence matchText1 = null;
                if (queryLength == 0) {
                    queryIndex = -1;
                } else {
                    lQueryForIndian = getPrefixCharForIndian(views.mText1.getPaint(), text1, lQuery.toCharArray());
                ...
                Log.d(LOG_TAG, " queryLength = " + queryLength);
                ...
                if (matchText1 == null) {
                    Object matchText12 = text1;
                }
                setViewText(textView, matchText1);
            } else {
        ...
        if (views.mText2 != null) {
            ...
            if (isURL) {
                ...
                if (queryLength == 0) {
                    ...
                    lQueryForIndian = getPrefixCharForIndian(views.mText1.getPaint(), text2_1, lQuery.toCharArray());
                    if (lQueryForIndian != null) {

...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    static final int[] ATTRS = new int[]{C0247R.attr.actionBarSize, 16842841};
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C02831();
        this.mRemoveActionBarHideOffset = new C02842();
        this.mAddActionBarHideOffset = new C02853();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0247R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0247R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0247R.id.action_bar));
        }
    }

...
public class ActionMenuView extends LinearLayoutCompat implements ItemInvoker, MenuView {
    ...
    public ActionMenuView(Context context, AttributeSet attrs) {
        ...
        this.mPopupTheme = 0;
        TypedArray a = context.obtainStyledAttributes(attrs, C0247R.styleable.View, C0247R.attr.actionButtonStyle, 0);
        this.mOriginalStartPadding = a.getDimensionPixelSize(C0247R.styleable.View_paddingStart, 0);
        this.mOriginalEndPadding = a.getDimensionPixelSize(C0247R.styleable.View_paddingEnd, 0);
        a.recycle();
        a = context.obtainStyledAttributes(attrs, C0247R.styleable.View, C0247R.attr.actionOverflowButtonStyle, 0);
        this.mOriginalOverflowStartPadding = a.getDimensionPixelSize(C0247R.styleable.View_paddingStart, 0);
        this.mOriginalOverflowEndPadding = a.getDimensionPixelSize(C0247R.styleable.View_paddingEnd, 0);
        this.mOverflowButtonMinWidth = a.getDimensionPixelSize(C0247R.styleable.View_android_minWidth, 0);
        a.recycle();
        this.mOverflowBadgeText = context.getResources().getString(C0247R.string.sesl_action_menu_overflow_badge_text_n);
    }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0247R.styleable.View, C0247R.attr.actionButtonStyle, 0);
        this.mOriginalStartPadding = a.getDimensionPixelSize(C0247R.styleable.View_paddingStart, 0);
        this.mOriginalEndPadding = a.getDimensionPixelSize(C0247R.styleable.View_paddingEnd, 0);
        a.recycle();
        a = getContext().obtainStyledAttributes(null, C0247R.styleable.View, C0247R.attr.actionOverflowButtonStyle, 0);
        this.mOriginalOverflowStartPadding = a.getDimensionPixelSize(C0247R.styleable.View_paddingStart, 0);
        this.mOriginalOverflowEndPadding = a.getDimensionPixelSize(C0247R.styleable.View_paddingEnd, 0);
        this.mOverflowButtonMinWidth = a.getDimensionPixelSize(C0247R.styleable.View_android_minWidth, 0);
        a.recycle();
                ...
                if (child instanceof ActionMenuItemView) {
                    ...
                    if (i == childCount - 1) {
                        if (!((ActionMenuItemView) child).hasText()) {
                            ((ActionMenuItemView) child).setIsLastItem(true);
                    ...
                    } else if (i < childCount - 1 && !((ActionMenuItemView) child).hasText()) {
                        ((ActionMenuItemView) child).setIsLastItem(false);
                    }
                } else if (lp.isOverflowButton) {
                    if (child instanceof OverflowMenuButton) {
                        ((ViewGroup) child).getChildAt(0).setPaddingRelative(this.mOriginalOverflowStartPadding, 0, this.mOriginalOverflowEndPadding, 0);
                        ((ViewGroup) child).getChildAt(0).setMinimumWidth(this.mOverflowButtonMinWidth);
                    } else {
                        child.setPaddingRelative(this.mOriginalOverflowStartPadding, 0, this.mOriginalOverflowEndPadding, 0);

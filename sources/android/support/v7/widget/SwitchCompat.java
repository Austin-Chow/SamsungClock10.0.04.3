...
import android.support.v7.animation.SeslElasticInterpolator;
...
public class SwitchCompat extends CompoundButton {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int switchWidth = getResources().getDimensionPixelSize(C0247R.dimen.sesl_switch_width);
    ...
    public void onPopulateAccessibilityEvent(AccessibilityEvent event) {
        ...
        String textOn = getResources().getString(C0247R.string.sesl_switch_on);
        String textOff = getResources().getString(C0247R.string.sesl_switch_off);
        if (isChecked()) {
            CharSequence text = textOn;
        } else {
            Object text2 = textOff;
        }
        if (text != null) {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case 1:
            case 3:
                if (VERSION.SDK_INT >= 28 && action == 1 && (this.mTouchMode == 2 || this.mTouchMode == 1)) {
    ...
    public void draw(Canvas c) {
        ...
        if (this.mThumbDrawable != null) {
            ...
            if (this.mThumbDrawable.getIntrinsicHeight() < switchBottom - switchTop) {
                int diff = this.mThumbDrawable.getIntrinsicHeight() / 2;
            }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        String textOff = getResources().getString(C0247R.string.sesl_switch_off);
        if (isChecked()) {
            CharSequence switchText = textOn;
        } else {
            Object switchText2 = textOff;
        }
    ...
    public void seslSetTrackStrokeColor(int color) {
        ((GradientDrawable) ((DrawableContainerState) this.mTrackDrawable.getConstantState()).getChildren()[2].findDrawableByLayerId(C0247R.id.sesl_switch_track_on)).setStroke(4, color);
    }
}

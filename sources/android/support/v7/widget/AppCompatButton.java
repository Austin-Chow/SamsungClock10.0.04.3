...
public class AppCompatButton extends Button implements TintableBackgroundView, AutoSizeableTextView {
    ...
    public void seslSetButtonShapeEnabled(boolean enabled) {
        Method method = SeslBaseReflector.getMethod(TextView.class, "semSetButtonShapeEnabled", Boolean.TYPE);
        if (method != null) {
            SeslBaseReflector.invoke(this, method, Boolean.valueOf(enabled));
        }
    }

    public void seslSetButtonShapeEnabled(boolean enabled, int textColor) {
        Method method = SeslBaseReflector.getMethod(TextView.class, "semSetButtonShapeEnabled", Boolean.TYPE, Integer.TYPE);
        if (method != null) {
            SeslBaseReflector.invoke(this, method, Boolean.valueOf(enabled), Integer.valueOf(textColor));
        }
    }
}

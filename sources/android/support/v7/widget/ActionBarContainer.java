...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        if (getId() == C0247R.id.split_action_bar) {
            this.mIsSplit = true;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0247R.id.action_bar);
        this.mContextView = findViewById(C0247R.id.action_context_bar);
    }
    ...
    public void setSplitBackground(Drawable bg) {
        ...
        if (bg != null) {
            ...
            if (this.mIsSplit && this.mSplitBackground != null) {
                this.mSplitBackground.setBounds(0, 0, getMeasuredWidth(), getMeasuredHeight() + getPaddingBottom());
            }
        }
        if (this.mIsSplit) {
            if (this.mSplitBackground != null) {

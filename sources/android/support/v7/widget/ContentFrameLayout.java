...
public class ContentFrameLayout extends FrameLayout {
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        getContext().getTheme().resolveAttribute(C0247R.attr.windowMinWidthMinor, this.mMinWidthMinor, true);
        getContext().getTheme().resolveAttribute(C0247R.attr.windowMinWidthMajor, this.mMinWidthMajor, true);
        updateAvailableWidth();
    }

...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    private int mSpinnerDropdownHorizontalOffset;
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        void computeContentWidth() {
            ...
            if (AppCompatSpinner.this.mDropDownWidth == -2) {
                ...
                setContentWidth(Math.max(contentWidth + 4, (spinnerWidth - spinnerPaddingLeft) - spinnerPaddingRight));
            ...
            setHorizontalOffset(AppCompatSpinner.this.mSpinnerDropdownHorizontalOffset + hOffset);
        }
        ...
        public void show() {
            ...
            if (!wasShowing) {
                ...
                if (vto != null) {
                    final OnGlobalLayoutListener layoutListener = new C02942();
    ...
    public void setDropDownHorizontalOffset(int pixels) {
        if (this.mPopup != null) {
            ...
            this.mSpinnerDropdownHorizontalOffset = pixels;
        } else if (VERSION.SDK_INT >= 16) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mPopup != null && MeasureSpec.getMode(widthMeasureSpec) == Integer.MIN_VALUE) {
            ...
            setMeasuredDimension(Math.min(contentWidth, MeasureSpec.getSize(widthMeasureSpec)), getMeasuredHeight());
        }
    }

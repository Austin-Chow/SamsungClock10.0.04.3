...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C04152();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C04141();
    ...
    class C04152 implements OnItemTouchListener {
        C04152() {
        }
        ...
        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent event) {
            ...
            if (action == 0) {
                ...
                if (ItemTouchHelper.this.mUsePagingTouchSlopForStylus) {
                    if (event.isFromSource(InputDeviceCompat.SOURCE_STYLUS)) {
                        ItemTouchHelper.this.mSlop = ItemTouchHelper.this.mSeslPagingTouchSlop;
                    } else {
                        ItemTouchHelper.this.mSlop = ItemTouchHelper.this.mSeslTouchSlop;
                    }
                }
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        class C04211 implements AnimatorUpdateListener {
            C04211() {
            }
        ...
        RecoverAnimation(ViewHolder viewHolder, int animationType, int actionState, float startDx, float startDy, float targetX, float targetY) {
            ...
            this.mValueAnimator.addUpdateListener(new C04211());
    ...
    class C04185 implements ChildDrawingOrderCallback {
        C04185() {
        }
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C04191();
        private static final Interpolator sDragViewScrollCapInterpolator = new C04202();
        private static final ItemTouchUIUtil sUICallback;
        private int mCachedMaxScrollSpeed = -1;

        /* renamed from: android.support.v7.widget.helper.ItemTouchHelper$Callback$1 */
        static class C04191 implements Interpolator {
            C04191() {
            }
        ...
        static class C04202 implements Interpolator {
            C04202() {
            }
            ...
            if (this.mShouldReactToLongPress) {
                ...
                if (child != null) {
                    ...
                    if (!ItemTouchHelper.this.mCallback.hasDragFlag(ItemTouchHelper.this.mRecyclerView, vh)) {
                        vh.itemView.announceForAccessibility(ItemTouchHelper.this.mRecyclerView.getContext().getString(C0270R.string.dragndroplist_item_cannot_be_dragged, new Object[]{Integer.valueOf(vh.getLayoutPosition() + 1)}));
                    } else if (e.getPointerId(0) == ItemTouchHelper.this.mActivePointerId) {
        ...
        if (selected != this.mSelected || actionState != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (prevSelected.itemView.getParent() != null) {
                    ...
                    if (prevActionState == 2) {
                        animationType = 8;
                        this.mSelected.itemView.announceForAccessibility(this.mRecyclerView.getContext().getString(C0270R.string.dragndroplist_drag_release, new Object[]{Integer.valueOf(this.mSelected.getLayoutPosition() + 1)}));
                    } else if (swipeDir > 0) {
                        animationType = 2;
                    } else {
                        animationType = 4;
            ...
            if (selected != null) {
                ...
                if (actionState == 2) {
                    ...
                    this.mSelected.itemView.announceForAccessibility(this.mRecyclerView.getContext().getString(C0270R.string.dragndroplist_drag_start, new Object[]{Integer.valueOf(this.mSelected.getLayoutPosition() + 1)}));
                }
            }
            ...
            public void run() {
                if (ItemTouchHelper.this.mRecyclerView != null && ItemTouchHelper.this.mRecyclerView.isAttachedToWindow() && !anim.mOverridden && anim.mViewHolder.getAdapterPosition() != -1) {
                    ...
                    if ((animator == null || !animator.isRunning(null)) && !ItemTouchHelper.this.hasRunningRecoverAnim()) {
                        Log.d(ItemTouchHelper.TAG, "onSwiped is called for " + anim.mViewHolder);
                        ItemTouchHelper.this.mCallback.onSwiped(anim.mViewHolder, swipeDir);
                        ItemTouchHelper.this.endRecoverAnimation(anim.mViewHolder, false);
                        return;
                    }
    ...
    public void startDrag(ViewHolder viewHolder) {
        if (!this.mCallback.hasDragFlag(this.mRecyclerView, viewHolder)) {
            ...
            viewHolder.itemView.announceForAccessibility(this.mRecyclerView.getContext().getString(C0270R.string.dragndroplist_item_cannot_be_dragged, new Object[]{Integer.valueOf(viewHolder.getLayoutPosition() + 1)}));
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C04185();
            }

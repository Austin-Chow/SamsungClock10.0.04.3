    ...
    void animateMoveImpl(ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        if (getHostView() instanceof RecyclerView) {
            ...
            if (recyclerView.mBlackTop != -1 && holder.getLayoutPosition() == recyclerView.mChildHelper.getChildCount() - 1) {
                animation.setUpdateListener(new AnimatorUpdateListener() {
        ...
        animation.setDuration(getMoveDuration()).setInterpolator(this.mMoveInterpolator).setListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {

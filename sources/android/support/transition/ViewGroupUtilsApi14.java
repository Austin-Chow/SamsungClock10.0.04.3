...
class ViewGroupUtilsApi14 implements ViewGroupUtilsImpl {
    ...
    class C00771 extends LayoutTransition {
        C00771() {
        }
    ...
    public void suppressLayout(ViewGroup group, boolean suppress) {
        if (sEmptyLayoutTransition == null) {
            sEmptyLayoutTransition = new C00771();
        ...
        if (suppress) {
            ...
            if (layoutTransition != null) {
                ...
                if (layoutTransition != sEmptyLayoutTransition) {
                    group.setTag(C0071R.id.transition_layout_save, layoutTransition);
                }
            }
        ...
        layoutTransition = (LayoutTransition) group.getTag(C0071R.id.transition_layout_save);
        if (layoutTransition != null) {
            group.setTag(C0071R.id.transition_layout_save, null);

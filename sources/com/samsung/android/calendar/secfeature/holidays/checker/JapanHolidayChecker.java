...
public class JapanHolidayChecker {
    ...
    public boolean isHoliday(Time time) {
        ...
        if (time.month == 7 && time.monthDay == 11 && time.year > 2015 && time.year != 2020) {
            return true;
        }
        if (time.year == 2020 && time.month == 7 && time.monthDay == 10) {
            return true;
        }
        ...
        if (time.year <= 2018 && time.month == 11 && time.monthDay == 23) {
            return true;
        }
        if (time.year > 2019 && time.month == 1 && time.monthDay == 23) {
            return true;
        }
        ...
        if (time.year != 2020 && time.month == 9 && time.monthDay == getSiteiWeekDay(time.year, 9, 2, 1)) {
            return true;
        }
        if (time.year == 2020 && time.month == 6 && time.monthDay == 24) {
            return true;
        }
        if (time.year >= 1996 && time.year != 2020 && time.month == 6 && time.monthDay == getSiteiWeekDay(time.year, 6, 3, 1)) {
            return true;
        }
        if (time.year == 2020 && time.month == 6 && time.monthDay == 23) {
            return true;
        }
        ...
        if ((time.month == 8 && getAutumnDay(time.year) == time.monthDay + 1 && time.monthDay - 1 == getSiteiWeekDay(time.year, 8, 3, 1)) || is2019AdditionalHoliday(time)) {
            return true;
        }
        return false;
    }

    private boolean is2019AdditionalHoliday(Time time) {
        if (time.year == 2019 && time.month == 3 && time.monthDay == 30) {
            return true;
        }
        if (time.year == 2019 && time.month == 4 && time.monthDay == 1) {
            return true;
        }
        if (time.year == 2019 && time.month == 4 && time.monthDay == 2) {
            return true;
        }
        return time.year == 2019 && time.month == 9 && time.monthDay == 22;
    }
    ...
    public boolean isSubstHoliday(Time time) {
        ...
        if (time.year < 2019 && time.month == 11 && time.monthDay == 24 && time.weekDay == 1) {
            return true;
        }
        if (time.year > 2019 && time.month == 1 && time.monthDay == 24 && time.weekDay == 1) {
            return true;
        }

...
public class ScoverManager {
    ...
    public String getServiceVersionName() {
        int majorVersion = (sServiceVersion >> 24) & 255;
        int minorVersion = (sServiceVersion >> 16) & 255;
    ...
    static boolean isSupportableVersion(int supportableVersion) {
        int minorVersion = (supportableVersion >> 16) & 255;
        int revisions = supportableVersion & SupportMenu.USER_MASK;
        int serviceMinorVersion = (sServiceVersion >> 16) & 255;
        int serviceRevisions = sServiceVersion & SupportMenu.USER_MASK;
        if (((sServiceVersion >> 24) & 255) < ((supportableVersion >> 24) & 255) || serviceMinorVersion < minorVersion || serviceRevisions < revisions) {
            return false;
        }
        return true;
    }
